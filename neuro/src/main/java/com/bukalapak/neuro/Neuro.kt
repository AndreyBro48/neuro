...
class Neuro {
    ...
    private fun proceedInternal(
        ...
        val signal = extractSignal(chosenNucleus, context, branch, uri, args) ?: return ErrorResult()
        ...
        if (branch == null) return ErrorResult()
        ...
        val t:Result = usedAxonPreprocessor.invoke(
            usedAxonProcessor,
            branch.action,
            signal
        )
